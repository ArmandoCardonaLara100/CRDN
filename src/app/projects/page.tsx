...
const projects = [
  {
    id: "proyecto-1", index: "Proyecto 01 — Retail", title: "Tienda de Calzado", location: "León, MX", year: "2024", category: "Retail · Calzado", image: "/images/case1-hd.png", alt: "Tienda de calzado diseñada por CRDN",
  ...
  {
    id: "proyecto-2", index: "Proyecto 02 — Retail", title: "Boutique Premium", location: "Ciudad de México, MX", year: "2023", category: "Retail · Moda", image: "/images/case2-hd.png", alt: "Boutique premium diseñada por CRDN",
  ...
  {
    id: "proyecto-3", index: "Proyecto 03 — Comercial", title: "Módulo Comercial", location: "Guadalajara, MX", year: "2022", category: "Comercial · Activación", image: "/images/case3-hd.png", alt: "Módulo comercial diseñado por CRDN",
...
export default function ProjectsPage() {
  return <SiteChrome kind="projects" footerNote="Retail, brand & commercial design — diseñamos espacios que trabajan para tu marca desde México, desde 2009.">
    <main id="content">
      <section className="shell page-hero"><div className="reveal"><Link className="back-link" href="/"><BackArrow />Volver al inicio</Link><h1 className="page-hero__title">Comportamiento del Consumidor</h1><p className="page-hero__intro">Cada espacio se diseña a partir de la identidad de la marca, el comportamiento del consumidor y los objetivos específicos de cada negocio.</p></div></section>
