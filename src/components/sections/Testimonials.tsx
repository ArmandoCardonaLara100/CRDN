  ...
  return (
    <section id="testimonials">
            ...
            return (
              <Reveal key={t.name} delay={i * 0.1} className="h-full">
                <figure className="flex h-full flex-col bg-plaster p-8 lg:p-10">
                  <figcaption className="eyebrow text-umber">
                    {t.role}
                  </figcaption>
      ...
      <Modal
        ...
        title={selected ? `Testimonial from ${selected.name}` : "Testimonial"}
      ...
      >
        {selected && (
          <figure className="p-8 pt-16 md:p-14 md:pt-16">
            <figcaption className="eyebrow text-umber">{selected.role}</figcaption>
